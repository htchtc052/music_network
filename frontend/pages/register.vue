...
<template>
  <div class="flex flex-col justify-center p-6 pb-12">
    ...
    <div class="mx-auto mt-10 w-full max-w-md rounded-xl border border-green-700 p-10">
      <form action="#" autocomplete="off" class="space-y-6" @submit.prevent="handleRegister">
        <div>
          <div v-if="form_errors?.email" class="text-red-700">
            {{ form_errors?.username }}
          </div>
          <label class="mb-1 block text-sm text-gray-800" for="username">Username</label>
          <input
        ...
        <div>
          ...
          <label class="mb-1 block text-sm text-gray-800" for="email">Email</label>
          <input
            v-model="form.email"
            class="w-full rounded-md"
            name="email"
        ...
        <div class="border">
          ...
          <label class="mb-1 block text-sm text-gray-800" for="password">Password</label>
          <input
        ...
        <div>
          ...
          <label class="mb-1 block text-sm text-gray-800" for="password_confirmation"
